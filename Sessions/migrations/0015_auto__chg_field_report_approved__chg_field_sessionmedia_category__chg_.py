...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.approved'
        db.alter_column(u'Sessions_report', 'approved', self.gf('django.db.models.fields.BooleanField')(default=2))

        # Changing field 'SessionMedia.category'
        db.alter_column(u'Sessions_sessionmedia', 'category', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Removing M2M table for field coord on 'CoordinatorsAttendance'
        db.delete_table(db.shorten_name(u'Sessions_coordinatorsattendance_coord'))
        ...
        # Changing field 'NewSession.approved'
        db.alter_column(u'Sessions_newsession', 'approved', self.gf('django.db.models.fields.BooleanField')(default=0))

    def backwards(self, orm):

        # Changing field 'Report.approved'
        db.alter_column(u'Sessions_report', 'approved', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'SessionMedia.category'
        db.alter_column(u'Sessions_sessionmedia', 'category', self.gf('django.db.models.fields.IntegerField')(default=1))
        # Adding M2M table for field coord on 'CoordinatorsAttendance'
        m2m_table_name = db.shorten_name(u'Sessions_coordinatorsattendance_coord')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('coordinatorsattendance', models.ForeignKey(orm[u'Sessions.coordinatorsattendance'], null=False)),
            ('profile', models.ForeignKey(orm[u'profile.profile'], null=False))
        ...
        # Changing field 'NewSession.approved'
        db.alter_column(u'Sessions_newsession', 'approved', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'Sessions.newsession': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 18, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 18, 0, 0)'}),
