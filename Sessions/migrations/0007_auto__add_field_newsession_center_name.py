...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewSession.center_name'
        db.add_column(u'Sessions_newsession', 'center_name',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['masters.Center'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NewSession.center_name'
        db.delete_column(u'Sessions_newsession', 'center_name_id')
    ...
    models = {
        ...
        u'Sessions.newsession': {
            ...
            'center_name': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['masters.Center']", 'null': 'True'}),
