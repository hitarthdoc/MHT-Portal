...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column("sessions_attendance","ymht_id","profile_id")

    def backwards(self, orm):
        db.rename_column("sessions_attendance","profile_id","ymht_id")

    models = {
        u'Sessions.attendance': {
            'Meta': {'object_name': 'Attendance'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profile': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['profile.Profile']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        u'Sessions.newsession': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 21, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 21, 0, 0)'}),
