...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewSession.created_by'
        db.add_column(u'Sessions_newsession', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewSession.created_by'
        db.delete_column(u'Sessions_newsession', 'created_by_id')
    ...
    models = {
        ...
        u'Sessions.newsession': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 16, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 16, 0, 0)'}),
