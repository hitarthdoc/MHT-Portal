...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewSession.email_content'
        db.delete_column(u'Sessions_newsession', 'email_content')

        # Deleting field 'NewSession.age_group'
        db.delete_column(u'Sessions_newsession', 'age_group_id')

        # Adding field 'NewSession.email_subject'
        db.add_column(u'Sessions_newsession', 'email_subject',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewSession.email_body'
        db.add_column(u'Sessions_newsession', 'email_body',
        ...
        # Changing field 'NewSession.sms_content'
        db.alter_column(u'Sessions_newsession', 'sms_content', self.gf('django.db.models.fields.TextField')(max_length=160, null=True))

    def backwards(self, orm):
        # Adding field 'NewSession.email_content'
        db.add_column(u'Sessions_newsession', 'email_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewSession.age_group'
        db.add_column(u'Sessions_newsession', 'age_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['masters.AgeGroup'], null=True),
                      keep_default=False)

        # Deleting field 'NewSession.email_subject'
        db.delete_column(u'Sessions_newsession', 'email_subject')

        # Deleting field 'NewSession.email_body'
        db.delete_column(u'Sessions_newsession', 'email_body')
        ...
        # Changing field 'NewSession.sms_content'
        db.alter_column(u'Sessions_newsession', 'sms_content', self.gf('django.db.models.fields.TextField')(null=True))
