...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Report.approved'
        raise RuntimeError("Cannot reverse this migration. 'Report.approved' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Report.approved'
        db.alter_column(u'Sessions_report', 'approved', self.gf('django.db.models.fields.BooleanField')())

        # User chose to not deal with backwards NULL issues for 'NewSession.approved'
        raise RuntimeError("Cannot reverse this migration. 'NewSession.approved' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'NewSession.approved'
        db.alter_column(u'Sessions_newsession', 'approved', self.gf('django.db.models.fields.BooleanField')())
