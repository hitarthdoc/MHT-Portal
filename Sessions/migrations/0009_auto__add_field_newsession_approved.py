...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewSession.approved'
        db.add_column(u'Sessions_newsession', 'approved',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewSession.approved'
        db.delete_column(u'Sessions_newsession', 'approved')
    ...
    models = {
        u'Sessions.attendance': {
            ...
            'ymht': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['profile.Membership']", 'null': 'True', 'symmetrical': 'False'})
        },
        u'Sessions.coordinatorsattendance': {
            'Meta': {'object_name': 'CoordinatorsAttendance'},
            'coordinators': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['profile.Profile']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Sessions.Report']", 'null': 'True'})
        },
        u'Sessions.newsession': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
