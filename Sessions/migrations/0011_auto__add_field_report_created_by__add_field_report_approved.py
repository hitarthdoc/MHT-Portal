...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.created_by'
        db.add_column(u'Sessions_report', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Report.approved'
        db.add_column(u'Sessions_report', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=1),
                      keep_default=False)

        # Removing M2M table for field ymht on 'CoordinatorsAttendance'
        db.delete_table(db.shorten_name(u'Sessions_coordinatorsattendance_ymht'))
    ...
    def backwards(self, orm):
        # Deleting field 'Report.created_by'
        db.delete_column(u'Sessions_report', 'created_by_id')

        # Deleting field 'Report.approved'
        db.delete_column(u'Sessions_report', 'approved')

        # Adding M2M table for field ymht on 'CoordinatorsAttendance'
        m2m_table_name = db.shorten_name(u'Sessions_coordinatorsattendance_ymht')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('coordinatorsattendance', models.ForeignKey(orm[u'Sessions.coordinatorsattendance'], null=False)),
            ('profile', models.ForeignKey(orm[u'profile.profile'], null=False))
    ...
    models = {
        ...
        u'Sessions.coordinatorsattendance': {
            ...
            'coord': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['profile.Profile']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Sessions.Report']", 'null': 'True'})
        },
