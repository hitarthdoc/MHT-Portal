...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Center.center_name'
        db.add_column(u'masters_center', 'center_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Center.center_name'
        db.delete_column(u'masters_center', 'center_name')
    ...
    models = {
        ...
        u'masters.center': {
            ...
            'locality': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
