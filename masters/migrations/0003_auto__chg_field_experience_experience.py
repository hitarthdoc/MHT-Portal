...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'masters_experience', 'experience', self.gf('django.db.models.fields.CharField')(max_length=63, null=True))

    def backwards(self, orm):

        # Changing field 'Experience.experience'
        db.alter_column(u'masters_experience', 'experience', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
