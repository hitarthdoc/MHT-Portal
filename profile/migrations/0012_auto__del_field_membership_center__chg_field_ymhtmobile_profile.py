...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Membership.center'
        db.delete_column(u'profile_membership', 'center_id')

        # Adding M2M table for field center on 'Membership'
        m2m_table_name = db.shorten_name(u'profile_membership_center')
        ...
        db.create_unique(m2m_table_name, ['membership_id', 'center_id'])


        # Changing field 'YMHTMobile.profile'
        db.alter_column(u'profile_ymhtmobile', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['profile.Profile']))

    def backwards(self, orm):
        # Adding field 'Membership.center'
        db.add_column(u'profile_membership', 'center',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['masters.Center']),
                      keep_default=False)

        # Removing M2M table for field center on 'Membership'
        db.delete_table(db.shorten_name(u'profile_membership_center'))


        # Changing field 'YMHTMobile.profile'
        db.alter_column(u'profile_ymhtmobile', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.Profile'], null=True))
    ...
    models = {
        ...
        u'profile.membership': {
            ...
            'center': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['masters.Center']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
