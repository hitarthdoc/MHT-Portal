...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YMHTAddress.is_active'
        db.delete_column(u'profile_ymhtaddress', 'is_active')

        # Adding field 'YMHTAddress.current_address'
        db.add_column(u'profile_ymhtaddress', 'current_address',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'YMHTAddress.is_active'
        db.add_column(u'profile_ymhtaddress', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'YMHTAddress.current_address'
        db.delete_column(u'profile_ymhtaddress', 'current_address')
