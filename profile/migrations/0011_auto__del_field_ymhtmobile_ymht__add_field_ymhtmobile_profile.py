...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YMHTMobile.ymht'
        db.delete_column(u'profile_ymhtmobile', 'ymht_id')

        # Adding field 'YMHTMobile.profile'
        db.add_column(u'profile_ymhtmobile', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.Profile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'YMHTMobile.ymht'
        db.add_column(u'profile_ymhtmobile', 'ymht',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.Profile'], null=True),
                      keep_default=False)

        # Deleting field 'YMHTMobile.profile'
        db.delete_column(u'profile_ymhtmobile', 'profile_id')
    ...
    models = {
        ...
        u'profile.ymhtmobile': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profile.Profile']", 'null': 'True'})
        }
    }
