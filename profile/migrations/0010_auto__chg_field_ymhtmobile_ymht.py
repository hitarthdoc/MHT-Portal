...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'YMHTMobile.ymht'
        db.alter_column(u'profile_ymhtmobile', 'ymht_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.Profile'], null=True))

    def backwards(self, orm):

        # Changing field 'YMHTMobile.ymht'
        db.alter_column(u'profile_ymhtmobile', 'ymht_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['profile.Profile']))
    ...
    models = {
        ...
        u'profile.ymhtmobile': {
            ...
            'ymht': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profile.Profile']", 'null': 'True'})
        }
    }
