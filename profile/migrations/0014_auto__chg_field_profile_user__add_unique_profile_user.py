...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profile_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Profile', fields ['user']
        db.create_unique(u'profile_profile', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['user']
        db.delete_unique(u'profile_profile', ['user_id'])


        # Changing field 'Profile.user'
        db.alter_column(u'profile_profile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
