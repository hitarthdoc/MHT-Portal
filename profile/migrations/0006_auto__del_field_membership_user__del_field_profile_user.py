...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Membership.user'
        db.delete_column(u'profile_membership', 'user_id')

        # Deleting field 'Profile.user'
        db.delete_column(u'profile_profile', 'user_id')

        # Adding M2M table for field user on 'Profile'
        m2m_table_name = db.shorten_name(u'profile_profile_user')
    ...
    def backwards(self, orm):
        # Adding field 'Membership.user'
        db.add_column(u'profile_membership', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Profile.user'
        db.add_column(u'profile_profile', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Removing M2M table for field user on 'Profile'
        db.delete_table(db.shorten_name(u'profile_profile_user'))
