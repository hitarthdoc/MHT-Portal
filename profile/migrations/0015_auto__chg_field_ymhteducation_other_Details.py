...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'YMHTEducation.other_Details'
        db.alter_column(u'profile_ymhteducation', 'other_Details', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'YMHTEducation.other_Details'
        db.alter_column(u'profile_ymhteducation', 'other_Details', self.gf('django.db.models.fields.TextField')(default=None))
