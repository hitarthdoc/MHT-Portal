...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YMHTJob.jobtype'
        db.delete_column(u'profile_ymhtjob', 'jobtype_id')

        # Adding field 'YMHTJob.job_type'
        db.add_column(u'profile_ymhtjob', 'job_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['masters.JobType'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'YMHTEducation.type_1'
        db.delete_column(u'profile_ymhteducation', 'type_1')

        # Adding field 'YMHTEducation.institution_name'
        db.add_column(u'profile_ymhteducation', 'institution_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)


        # Changing field 'YMHTEducation.school_or_College'
        db.alter_column(u'profile_ymhteducation', 'school_or_College', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'YMHTJob.jobtype'
        raise RuntimeError("Cannot reverse this migration. 'YMHTJob.jobtype' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'YMHTJob.jobtype'
        db.add_column(u'profile_ymhtjob', 'jobtype',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['masters.JobType']),
                      keep_default=False)

        # Deleting field 'YMHTJob.job_type'
        db.delete_column(u'profile_ymhtjob', 'job_type_id')


        # User chose to not deal with backwards NULL issues for 'YMHTEducation.type_1'
        raise RuntimeError("Cannot reverse this migration. 'YMHTEducation.type_1' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'YMHTEducation.type_1'
        db.add_column(u'profile_ymhteducation', 'type_1',
                      self.gf('django.db.models.fields.CharField')(max_length=256),
                      keep_default=False)

        # Deleting field 'YMHTEducation.institution_name'
        db.delete_column(u'profile_ymhteducation', 'institution_name')


        # Changing field 'YMHTEducation.school_or_College'
        db.alter_column(u'profile_ymhteducation', 'school_or_College', self.gf('django.db.models.fields.CharField')(max_length=255))
