...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.till'
        db.alter_column(u'profile_membership', 'till', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Membership.till'
        db.alter_column(u'profile_membership', 'till', self.gf('django.db.models.fields.DateField')(default=3))
    ...
    models = {
        ...
        u'profile.membership': {
            ...
            'till': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'ymht': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profile.Profile']"})
        },
        u'profile.profile': {
