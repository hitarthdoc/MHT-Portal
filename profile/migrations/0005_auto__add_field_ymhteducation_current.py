...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YMHTEducation.current'
        db.add_column(u'profile_ymhteducation', 'current',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YMHTEducation.current'
        db.delete_column(u'profile_ymhteducation', 'current')
